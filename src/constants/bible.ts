...
/**
 * English book names mapping for reference search
 * Maps English book names to internal book IDs
 */
export const BOOKS_BY_ENGLISH_NAME = new Map<string, string>([
  // Old Testament
  ['genesis', 'genesis'],
  ['exodus', 'exodus'],
  ['leviticus', 'leviticus'],
...
export const DATA_PATHS = {
  base: '/public',
  oldTestament: '/public/Testameta taloha',
  newTestament: '/public/Testameta vaovao',
} as const;
